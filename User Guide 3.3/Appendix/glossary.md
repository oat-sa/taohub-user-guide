...
<!--
## Cloning Engine
A system for creating multiple similar items (or Item Clones) from an Item Template. [TAO]({UG}/introduction/take-a-tour.md) uses a Cloning Engine to assist users in authoring Items.
-->
...
<!--
## Item Clone
An [Item]({UG}/items/what-is-an-item.md) which is similar to others created by an Item Template. These are identical except for designated variables called Template Variables.

## Item Fragment
Part of an [Item]({UG}/items/what-is-an-item.md) managed independently from other parts. If it introduces all Items in a set, such a fragment is often referred to as a set leader.
-->
...
<!--
## Item Set
A group of [Items]({UG}/items/what-is-an-item.md) which share common characteristics.

## Item Template
A template used for producing large numbers of similar [Items]({UG}/items/what-is-an-item.md), often called Cloned Items. These will have one or more designated Template Variables, and will be governed by a set of Template processing rules which are assigned these values. These may be produced by a special purpose Cloning Engine, such as [TAO]({UG}/introduction/take-a-tour.md).
-->
...
<!--
## Non-adaptive Item
An [Item]({UG}/items/what-is-an-item.md) which does not change following attempts made by a Test-taker.

## Object Bank
A collection of objects used during an assessment, including [Items]({UG}/items/what-is-an-item.md), Item Fragments, or Test parts.
-->
...
<!--
## Pool
A special type of Object Bank which includes related [Items]({UG}/items/what-is-an-item.md) transported together with metadata which describes the group as a whole.
-->
...
<!--
## Test Fragment
Part of a [Test]({UG}/tests/what-is-a-test.md) managed independently.
-->
...
<!--
## Test Report
A report describing a [Test]({UG}/tests/what-is-a-test.md) Session.
-->
