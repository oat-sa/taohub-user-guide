...
**1.** From the Graphic Interactions library near the bottom of the *Interactions library* on the left, drag the *Gap Match* icon ![Grpahic Match](../resourse/_icons/graphic-match.png) onto the blank Item and drop it onto the [Canvas](../appendix/glossary.md#canvas).
