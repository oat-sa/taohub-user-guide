...
**1.** From the [Common Interactions Library](../appendix/glossary.md#common-interactions-library) on the left, drag the *Hottext* icon ![Hot Text](../resourse/_icons/hottext.png) onto the blank Item and drop it onto the [Canvas](../appendix/glossary.md#canvas).
