...
**2.** Once you have entered the text, drag the *Inline Choice* icon ![Inline Choice](../resourse/_icons/inline-choice.png) from the Inline Interactions library to a space next to where the test-taker will be expected to *fill in the blank*.
