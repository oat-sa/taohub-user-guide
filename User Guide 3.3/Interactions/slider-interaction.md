...
**1.** From the [Common Interactions Library](../appendix/glossary.md#common-interactions-library) on the left, drag the *Slider* icon ![Sliuder](../resourse/_icons/slider.png) onto the blank Item and drop it onto the [canvas](../appendix/glossary.md#canvas).
