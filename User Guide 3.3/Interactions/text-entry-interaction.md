...
> Text Entry [Interactions](../appendix/glossary.md#interaction) allow [Test-takers](../appendix/glossary.md#test-taker) to complete a "Fill in the Blank" question with an exact text answer. This interaction needs to be in a _Text Block_ ![Block](../resourses/_icons/font.png).
...
**2.** Once you have entered the text, drag the *Text Entry* icon ![Text Entry](../resourses/_icons/text-entry.png) from the Inline Interactions library to the space next to where the test-taker will be expected to *fill in the blank*.
