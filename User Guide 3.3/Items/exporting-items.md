...
**2.**  Select either an Item class ![class](../resources/_icons/folder.png) or an individual Item ![item](../resources/_icons/item.png) in the Item [Library](../appendix/glossary.md#library) on the left-hand side to select one or multiple items.

**4.**  After the selection, click *Export* ![export](../resources/_icons/export.png) in the button bank below the library.
